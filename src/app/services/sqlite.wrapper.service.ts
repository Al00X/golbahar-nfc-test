...
import {
  CapacitorSQLite,
  capEchoResult,
  capNCDatabasePathResult, capSQLiteChanges,
  capSQLiteResult, capSQLiteValues,
  SQLiteConnection, SQLiteDBConnection
} from "@capacitor-community/sqlite";
import {Capacitor} from "@capacitor/core";

// This source is copied from the `@capacitor-community/sqlite` setup guide
@Injectable({
  providedIn: 'root'
})
export class SqliteWrapperService {
